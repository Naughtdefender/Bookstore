...
describe("add book", () => {
  it("givenBookDetails_whenProper_shouldAddBook", (done) => {
    chai
      ...
      .set("token", token)
      .send(crudData.addBookWithCorrectDetails)
      .end((err, res) => {
  ...
  it("givenBookDetails_withWrongHttpMethod_shouldNotAddBook", (done) => {
    chai
      .request(server)
      .put("/books/createBook")
      .set("token", token)
      .send(crudData.addBookWithNoTitle)
      .end((err, res) => {
...
describe("update book", () => {
  it("givenBookDetails_whenProper_shouldUpdateBook", (done) => {
    chai
      .request(server)
      .put("/books/updateBook/611654e2a2f0493ca4ac2215")
      .set("token", token)
  ...
  it("givenBookDetails_whenWrongId_shouldNotUpdateBook", (done) => {
    chai
      .request(server)
      .put("/books/updateBook/611654e2a2f0493ca4ac2")
      .set("token", token)
      .send(crudData.updateBookWithCorrectDetails)
      .end((err, res) => {
  ...
  it("givenBookDetails_whenWrongHttpMathod_shouldNotUpdateBook", (done) => {
    chai
      .request(server)
      .post("/books/updateBook/611654e2a2f0493ca4ac2215")
      .set("token", token)
      .send(crudData.updateBookWithCorrectDetails)
      .end((err, res) => {
        res.should.have.status(404);
...
describe("delete book", () => {
  it.skip("givenBookDetails_whenProper_shouldDeleteBook", (done) => {
    chai
      .request(server)
      .delete("/books/deleteBook/61166e8534a6c54ad86c0452")
      .set("token", token)
      .end((err, res) => {
        res.should.have.status(200);
        done();
  ...
  it("givenBookDetails_whenImproperId_shouldNotDeleteBook", (done) => {
    chai
      .request(server)
      .delete("/books/deleteBook/61166e8534a6c54ad86c2")
      .set("token", token)
      .end((err, res) => {
        res.should.have.status(400);
        done();
  ...
  it("givenBookDetails_whenImproperURL_shouldNotDeleteBook", (done) => {
    chai
      .request(server)
      .post("/books/delete/61166e8534a6c54ad86c2")
      .set("token", token)
      .end((err, res) => {
        res.should.have.status(404);
        done();
  ...
  it("givenBookDetails_whenNoToken_shouldNotDeleteBook", (done) => {
    chai
      .request(server)
      .delete("/books/delete/61166e8534a6c54ad86c2")
      .send()
      .end((err, res) => {
        res.should.have.status(404);
        done();
